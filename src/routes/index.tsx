      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="container-edge text-center flex flex-col items-center">
          ...
          <div className="mt-20 relative w-full max-w-5xl">
            ...
            <div className="relative aspect-[16/9] md:aspect-[21/9] rounded-[2.5rem] overflow-hidden shadow-2xl border border-border bg-muted">
               <img src={ife} alt="Ife Central" className="h-full w-full object-cover grayscale hover:grayscale-0 transition-all duration-1000" />
            </div>
          </div>
        </div>
      </section>
